...
export default function Answer({ ans }) {
  ...
  return (
    <div className="text-left text-zinc-300 leading-7">
      <ReactMarkdown
        ...
        components={{
          ...
          table: ({ children }) => (
            <div className="overflow-x-auto my-5 rounded-lg border border-zinc-700">
          ...
          thead: ({ children }) => (
            <thead className="bg-zinc-800 text-white">{children}</thead>
          ),
          ...
          th: ({ children }) => (
            <th className="px-4 py-3 text-left font-semibold border-r border-zinc-700 last:border-r-0">
              {children}
            </th>
          ),

          td: ({ children }) => (
            <td className="px-4 py-3 border-r border-zinc-700 last:border-r-0">
              {children}
            </td>
          ),
          ...
          code: ({ inline, children }) => {
            if (inline) {
              return (
                <code className="bg-zinc-800 text-pink-300 px-1.5 py-0.5 rounded text-sm">
                  {children}
                </code>
              );
            }
            ...
            return (
              <div className="my-4 border border-zinc-700 rounded-lg overflow-hidden">
